    ...
    *fresh5 = 0 as *mut libc::c_char;
    loop {
        ...
        match *str as libc::c_int {
            ...
            35 => {
                if ss.sep {
                    current_block = 5636595834269784390;
                    break;
                }
            }
            92 => {
                        ...
                        != '\'' as i32)
                {
                    ...
                    match newc as libc::c_int {
                        34 | 35 | 36 | 39 | 92 => {}
                        95 => {
                            current_block = 5504193643923593725;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                                ...
                                9256768894290724928 => {
                                    ...
                                    current_block = 8306663921267213764;
                                }
                                _ => {}
                            }
                            match current_block {
                        ...
                        99 => {
                            current_block = 12051365830982011504;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        102 => {
                            current_block = 18014855578945748386;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        110 => {
                            current_block = 8889991735039304700;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        114 => {
                            current_block = 1239982780470697516;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        116 => {
                            current_block = 15121399610258435117;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        118 => {
                            current_block = 10209126403243722321;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        0 => {
                            current_block = 9256768894290724928;
                            match current_block {
                                5504193643923593725 => {
                                    if !dq {
                                        str = str.offset(1);
