            ...
            match format_char {
                37 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 8994259018498030420;
                    } else {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 5381395500544272558;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 6027584625296323944;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 14005755766885832912;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 14432620544119959731;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 2714136256769729136;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 12740376787977913198;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        u_number_value = ((*tp).tm_yday as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint);
                        current_block = 13914842097205694203;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                115 => {
                    ...
                    current_block = 167214429307987422;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 8994259018498030420;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 13941104960708053582;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        6027584625296323944 => {
                            ...
                            current_block = 1327278582464514970;
                        }
                        13941104960708053582 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            11256224404817644654 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 15962958903956949168;
                                            }
                                        ...
                                        current_block = 13194733245732625811;
                                    }
                                    1 => {
                                        current_block = 9136364834649731412;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 17797373342310498984;
                                        match current_block {
                                            11256224404817644654 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
